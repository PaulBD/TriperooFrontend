...
const FlightCard = ({quote, currency, position, journeyType, trackClick}) => {
  ...
  if (journeyType == 'round')
  {
    ...
    returnTripDetail = (
      <div className="col-12 col-md-6">
        <h5 className="flightReturn">Return <small> Duration: {returnTime.split(".")[0]}h {returnTime.split(".")[1]}m</small></h5>
        {
  ...
  let flightLabel = quote.cityTo + ' - ' + quote.flyTo;
      ...
      <div className="col-md-12 flightWrapper">
        <div className="row">
          ...
          <div className="col-12 col-md-2 text-center">
            <a href={quote.deep_link} target="_blank" onClick={trackClick} data-category="Flights" data-label={flightLabel} className="btn btn-secondary btnSearch btnFlightSearch"><small>BOOK FOR</small><span>{currencySml}{quote.price.toFixed(2)}</span></a>
