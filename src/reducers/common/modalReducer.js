...
export default function modalReducer(state = { isSending: false, hasPosted: false }, action) {
  ...
  switch(action.type) {
    ...
    case types.OPEN_BOOKMARK_MODEL:
      return Object.assign({}, state, { modalIsOpen: true, isSending: true, hasPosted: false, modalContent: { parentLocationId: action.parentLocationId, parentLocationName: action.parentLocationName, parentLocationNameLong: action.parentLocationNameLong, parentLocationImage: action.parentLocationImage, parentLocationUrl: action.parentLocationUrl, locationId: action.locationId, locationUrl: action.locationUrl, locationImage: action.locationImage, locationNameLong: action.locationNameLong, locationName: action.locationName, locationType: action.locationType, locationLength: action.locationLength, removeBookmark: action.removeBookmark, latitude: action.latitude , longitude: action.longitude }, modalName: action.name, modalType: 'Bookmark' });
